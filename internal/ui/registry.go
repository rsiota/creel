	...
	return []Section{
		...
		},
		{
			...
			Items: []Binding{
				...
				{"S", []string{"S"}, "cross-table search (:grep)", "S"},
		...
		},
		{
			...
			Items: []Binding{
				...
				{"yy / yw / y$", []string{"y", "w", "$"}, "yank line / word / to EOL", "y"},
		...
		},
		{
			...
			Items: []Binding{
				...
				{"V", []string{"V"}, "visual mode (select range; p fills column)", "V"},
		...
		},
		{
			...
			Items: []Binding{
				...
				{"o / enter", []string{"o", "enter"}, "fold / unfold JSON node", "o"},
				{"h / l", []string{"h", "l", "left", "right"}, "collapse / expand JSON node", "h/l"},
				{"e / i", []string{"e", "i"}, "edit field (JSON opens E)", "e"},
				{"E", []string{"E"}, "expand/view field (multi-line)", "E"},
				{"esc", []string{"esc"}, "collapse JSON tree", "esc"},
				{"g d", []string{"g", "d"}, "follow foreign key", ""},
		...
		},
		{
			...
			Items: []Binding{
				...
				{"g / G", []string{"g", "G"}, "top / bottom", "g/G"},
				{"ctrl+d / ctrl+u", []string{"ctrl+d", "ctrl+u"}, "page down / up", "ctrl+d/ctrl+u"},
				{"y", []string{"y"}, "copy row (full text)", "y"},
				{"enter", []string{"enter"}, "open table / load into editor", "enter"},
				{"esc", []string{"esc"}, "close", "esc"},
			},
		},
		{
		...
		},
		{
			...
			Items: []Binding{
				...
				{"x", []string{"x"}, "export Unicode snapshot to ~/Downloads", "x"},
				{"X", []string{"X"}, "export SVG to ~/Downloads", "X"},
				{":", []string{":"}, "ex command line", ":"},
				{"?", []string{"?"}, "help", "?"},
		...
		},
		{
			...
			Items: []Binding{
				...
				{"yy / yw / y$", []string{"y", "w", "$"}, "yank line / word / to EOL (normal)", "y"},
