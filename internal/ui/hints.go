...
func (m Model) resolveHints() (section string, hints []string) {
	...
	case m.erdPanel.IsVisible():
		...
		return "ERD", []string{"j/k/h/l", "H/J/K/L", "space", "enter", "f", "zz", "zc/zo/za", "zM/zR", "/", "p", "i", "m", "g/G", "ctrl+d/ctrl+u", "y", "esc"}
	...
	default:
		...
		case m.state == stateAddConnection:
			...
			if m.connForm.ActiveIsChoice() {
				return "", []string{"[/]", "j/k", "h/l", "p", "enter", "ctrl+t", "esc"}
			}
			return "", []string{"[/]", "j/k", "e", "p", "enter", "ctrl+t", "esc"}
