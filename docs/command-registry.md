...
`:describe`/`:desc [table]`, `:stats [column]`, `:bar[!] [label] [value] [sum|count|avg]`, `:freq[!] [column]`, `:line[!] [x] [y]`, `:scatter[!] [x] [y]`, `:hist[!] [column] [bins]`, `:format`, `:theme <name>`, `:color [slot] [hex|default]`.
